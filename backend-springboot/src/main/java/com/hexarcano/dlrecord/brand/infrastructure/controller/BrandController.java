...
public class BrandController {
     ...
     * @return A {@link ResponseEntity} with the created brand and an HTTP status of 201 (Created).
     */
    @PostMapping()
     ...
     * @return A {@link ResponseEntity} with a list of all brands and an HTTP status of 200 (OK).
     */
    @GetMapping()
     ...
     * @return A {@link ResponseEntity} with the found brand and HTTP status 200 (OK),
     *         or HTTP status 404 (Not Found) if the brand does not exist.
     */
    @GetMapping("/{id}")
     ...
     * @param id The unique identifier of the brand to update, passed in the URL path.
     * @param entity The updated brand data sent in the request body.
     * @return A {@link ResponseEntity} with the updated brand and HTTP status 200 (OK),
     *         or HTTP status 404 (Not Found) if the brand to update does not exist.
     */
    @PutMapping("/{id}")
     ...
     * @param id The unique identifier of the brand to delete, passed in the URL path.
     * @return A {@link ResponseEntity} with HTTP status 200 (OK) if deletion was successful,
     *         or HTTP status 404 (Not Found) if the brand does not exist.
     */
    @DeleteMapping("/{id}")
