 ...
 * Defines the contract for querying brand information from the application core.
 */
public interface IRetrieveBrand {
     ...
     * @return An {@link Optional} containing the {@link Brand} if found, or an empty Optional if not.
     */
     ...
     *
     * @return A {@link List} of all {@link Brand} objects. The list may be empty if no brands exist.
     */
    List<Brand> findAll();
}
